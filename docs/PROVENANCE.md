...
- Upstream revision: `3768a19140ce0c3fcc602b3d879960b16be1462b`.
...
- Cấu hình HA và autoscaling cần kiểm chứng trên cluster đích; kết quả phụ thuộc tài nguyên, storage và network.
